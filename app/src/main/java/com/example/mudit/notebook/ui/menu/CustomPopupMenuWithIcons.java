package com.example.mudit.notebook.ui.menu;
...
//custom popup menu class for adding icons with text

public class CustomPopupMenuWithIcons implements MenuBuilder.Callback, MenuPresenter.Callback {
    ...
    public interface OnDismissListener {
         ...
         */
        public void onDismiss(CustomPopupMenuWithIcons menu);
    }
     ...
     */
    public CustomPopupMenuWithIcons(Context context, View anchor) {
     ...
     *        anchor.
     */
    public CustomPopupMenuWithIcons(Context context, View anchor, int gravity) {
     ...
     */
    public CustomPopupMenuWithIcons(Context context, View anchor, int gravity, int popupStyleAttr,
                                    int popupStyleRes) {
        mContext = context;
    ...
    public void forceShowingIconsForPopUpMenu(){
        mPopup.setForceShowIcon(true); //ADD THIS LINE
